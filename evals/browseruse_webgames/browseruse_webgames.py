...
from browser_use.controller.registry.views import ActionModel as BrowserActionModel
from dotenv import load_dotenv
from inspect_ai import Epochs, Task, eval, eval_async, eval_retry, task
...
def load_webgames_dataset(jsonl_file_path: str) -> MemoryDataset:
    ...
    task_prompt_template = (
        "go to http://localhost:5173/{task_id} and complete the challenge "
